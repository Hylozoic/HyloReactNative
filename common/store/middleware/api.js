...
import { API_HOST, IOS_EMULATOR_API_HOST, EMULATOR_API_HOST } from 'react-native-dotenv'
import { getSessionCookie, setSessionCookie } from '../../util/session'
import DeviceInfo from 'react-native-device-info'

const HOST = DeviceInfo.isEmulator() ? (Platform.OS === 'ios' ? IOS_EMULATOR_API_HOST : EMULATOR_API_HOST) : API_HOST
