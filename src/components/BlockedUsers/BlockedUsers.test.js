...
import BlockedUsers, { MessageSettingsRow, AllCommunitiesSettingsRow, MembershipSettingsRow, SettingsRow, SettingsIcon } from './BlockedUsers'
...
describe('BlockedUsers', () => {
  ...
  describe('updateMessageSettings', () => {
    it('calls updateUserSettings', () => {
      ...
      const instance = ReactTestRenderer.create(<BlockedUsers {...props} />).getInstance()
  ...
  it('has navigationOptions', () => {
    ...
    expect(BlockedUsers.navigationOptions({ navigation })).toMatchSnapshot()
  })
})
